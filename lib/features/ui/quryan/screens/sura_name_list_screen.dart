...
getJsonData()async{
 final responseData = await rootBundle.loadString("assets/data/sura_list.json");
        ...
        itemBuilder: (context,index){
            ...
            return GestureDetector(
              ...
              child: ListTile(
               ...
               title: Text(data['englishName'],style: TextStyle(
                 fontWeight: FontWeight.bold,
                 color: AppColors.primaryColor
               ),),
               subtitle: Text(data['name'],style: TextStyle(
                fontWeight: FontWeight.w500,
               ),),
               trailing: Column(
                 children: [
                   Text(data["revelationType"],style: TextStyle(
                     fontWeight: FontWeight.w500,
                       color: AppColors.primaryColor
                   ),),
                   Text( 'Ayat ${data['ayatNumber']}'.toString(),
                     style: TextStyle(
                       fontWeight: FontWeight.w500,
                       color: AppColors.primaryColor
                   ),),
