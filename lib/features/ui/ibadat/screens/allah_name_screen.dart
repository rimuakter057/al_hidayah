...
import 'package:hidayah/features/ui/ibadat/screens/widget/allah_name.dart';
          ...
          children: [
            Padding(
              padding: EdgeInsets.symmetric(
                vertical: AppSizes.width(context) * 0.015,
              ),
              child: Text(
                "আল-আস্মাউল-হুসনা",
            ...
            Expanded(
              child: ListView.builder(
                itemCount:
                    AllahNameData
                        .allahNames
                        .length, // Using the fixed list of names
